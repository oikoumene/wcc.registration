...
from wcc.registration.interfaces import IExtendRegistrationForm, ExtendRegistrationForm
...
class RegisterForm(RegistrationForm):
    ...
    def validate_registration(self, action, data):
        ...
        ratool = getToolByName(self.context, 'wcc_membership_registration_approval')
